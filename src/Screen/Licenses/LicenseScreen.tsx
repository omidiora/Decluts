...
const 
LicenseScreen = ({number = 1}: number) => {
  return (
    <ScrollView
      style={styles.LincenseContainer}
      ...
      <View style={styles.subContent}>
        ...
        <Text style={styles.content}>
          Welcome to Declut! These terms outline the conditions under which you
          may access and use the Declut mobile application and related services.
          By using the app, you agree to abide by these terms. If you do not
